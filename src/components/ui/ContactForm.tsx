                                                ...
                                                <div className='input_styled input_back'>
                                                    ...
                                                    <FormControl>
                                                        <Input {...field}
                                                            type='text'
                                                            autoComplete='name'
                                                            className='font-medium text-lg md:text-xl pb-2'
                                                        />
                                                    </FormControl>
                                                </div>
                                                <FormMessage />
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                <div className='relative flex items-start bg-[#933835] border border-[#BB4F33] rounded-xl px-5 py-2 input_back'>
                                                    ...
                                                    <FormControl>
                                                        <Textarea {...field}
                                                            className='font-medium text-lg md:text-xl py-0 px-2 h-36 resize-none'
                                                        />
                                                    </FormControl>
                                                    <Button className='absolute z-10 bottom-2.5 right-2.5 text-black px-2.5' type="submit">
